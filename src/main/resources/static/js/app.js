...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.push.js */ \"./node_modules/core-js/modules/es.array.push.js\");\n/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  data() {\n    return {\n      requestBody: {},\n      // List page data transfer\n      list: {},\n      //list data\n      no: \"\",\n      // board number\n      paging: {\n        block: 0,\n        end_page: 0,\n        next_block: 0,\n        page: 0,\n        page_size: 0,\n        prev_block: 0,\n        start_index: 0,\n        start_page: 0,\n        total_block_cnt: 0,\n        total_list_cnt: 0,\n        total_page_cnt: 0\n      },\n      // paging data\n      page: this.$route.query.page ? this.$route.query.page : 1,\n      size: this.$route.query.size ? this.$route.query.size : 10,\n      keyword: this.$route.query.keyword,\n      paginavigation: function () {\n        // handle paging\n        let pageNumber = []; //;\n        let start_page = this.paging.start_page;\n        let end_page = this.paging.end_page;\n        for (let i = start_page; i <= end_page; i++) pageNumber.push(i);\n        return pageNumber;\n      }\n    };\n  },\n  mounted() {\n    this.fnGetList();\n  },\n  methods: {\n    fnGetList() {\n      this.requestBody = {\n        keyword: this.keyword,\n        page: this.page,\n        size: this.size\n      };\n      this.$axios.get(\"/api/sampleboard/list\", {\n        params: this.requestBody,\n        headers: {}\n      }).then(res => {\n        console.log(\"response:\", res.data);\n        this.list = res.data;\n      }).catch(err => {\n        if (err.message.indexOf(\"Network Error\") > -1) {\n          alert(err.message);\n        }\n      });\n    },\n    fnView(id) {\n      this.requestBody.id = id;\n      this.$router.push({\n        path: \"./detail\",\n        query: this.requestBody\n      });\n    },\n    fnWrite() {\n      this.$router.push({\n        path: \"./write\"\n      });\n    },\n    fnPage(n) {\n      if (this.page !== n) {\n        this.page = n;\n        this.fnGetList();\n      }\n    }\n  }\n});\n\n//# sourceURL=webpack://cbxjuzv2/./src/views/sampleboard/SampleBoardList.vue?./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use%5B0%5D!./node_modules/vue-loader/dist/index.js??ruleSet%5B0%5D.use%5B0%5D");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.push.js */ \"./node_modules/core-js/modules/es.array.push.js\");\n/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  data() {\n    return {\n      requestBody: this.$route.query,\n      id: this.$route.query.id,\n      title: \"\",\n      author: \"\",\n      contents: \"\",\n      create_time: \"\"\n    };\n  },\n  mounted() {\n    this.fnGetView();\n  },\n  methods: {\n    fnGetView() {\n      if (this.id !== undefined) {\n        this.$axios.get(this.$serverUrl + \"/board/\" + this.id, {\n          params: this.requestBody\n        }).then(res => {\n          this.title = res.data.title;\n          this.author = res.data.author;\n          this.contents = res.data.contents;\n          this.create_time = res.data.create_time;\n        }).catch(err => {\n          console.log(err);\n        });\n      }\n    },\n    fnList() {\n      delete this.requestBody.id;\n      this.$router.push({\n        path: \"./list\",\n        query: this.requestBody\n      });\n    },\n    fnView(id) {\n      this.requestBody.id = id;\n      this.$router.push({\n        path: \"./detail\",\n        query: this.requestBody\n      });\n    },\n    fnSave() {\n      let apiUrl = this.$serverUrl + \"/board\";\n      this.form = {\n        id: this.id,\n        title: this.title,\n        contents: this.contents,\n        author: this.author\n      };\n      if (this.id === undefined) {\n        //INSERT\n        this.$axios.post(apiUrl, this.form).then(res => {\n          alert(\"글이 저장되었습니다.\");\n          this.fnView(res.data.id);\n        }).catch(err => {\n          if (err.message.indexOf(\"Network Error\") > -1) {\n            alert(err.message);\n          }\n        });\n      } else {\n        //UPDATE\n        this.$axios.patch(apiUrl, this.form).then(res => {\n          alert(\"글이 저장되었습니다.\");\n          this.fnView(res.data.id);\n        }).catch(err => {\n          if (err.message.indexOf(\"Network Error\") > -1) {\n            alert(err.message);\n          }\n        });\n      }\n    }\n  }\n});\n\n//# sourceURL=webpack://cbxjuzv2/./src/views/sampleboard/SampleBoardWrite.vue?./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use%5B0%5D!./node_modules/vue-loader/dist/index.js??ruleSet%5B0%5D.use%5B0%5D");
